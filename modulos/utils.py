...
def gerar_documento_contrato(lead_dados, mrr_formatado, setup_formatado, condicao_txt, itens_orcamento=None):
    ...
    mapa_servicos = {
        "srv_2_1": ["000254000000096"], 
        "srv_2_2": ["000254000000042","000254000000377","000254000000458"], 
        "srv_2_3": ["000254000000657"], 
        "srv_2_4": ["000254000000389","000254000000352"], 
        "srv_2_5": ["000254000000102"], 
        "srv_2_6": ["000254000000458"], 
        "srv_2_7": [""], 
        "srv_2_8": ["000254000000628","000254000000630","000254000000631"], 
        "srv_2_9": [""], 
        "srv_2_10": ["000254000000318"] 
    }
